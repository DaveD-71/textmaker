...
- explain the role of slides, notes, pre-reads, worksheets, leave-behinds, and backup materials
...
| Refer to a leave-behind | "After the meeting, I will send a one-page summary with the next steps." |
...
- any pre-read, worksheet, appendix, leave-behind, or backup material
