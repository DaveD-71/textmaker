# Let's Talk Finance 2 (Book B) — Full QA Checklist (whole book, Phase 5)
...
Companion: `../../Let's Talk Finance/drafts/control/qa-checklist-full.md` (structurally identical).
...
- [ ] No Book B topic has drifted into a Book A topic's territory (see `project-plan.md` §4 overlap watch); where close, the Book B treatment stays distinct.
