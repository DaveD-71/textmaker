...
**Writing goal:** Give the reader enough information to locate the issue and understand what you are asking about.
...
**Writing goal:** Ask questions that are precise, specific, and easy for the recipient to answer without further clarification.
...
You are a coordination officer at a national processing office. Your office submitted a full set of applicant documents to an interagency partner three weeks ago. You have received no confirmation of receipt, and your internal deadline is approaching.

Write a formal external inquiry to the partner office. Your inquiry must include:
...
**Writing task:** Using the data in the table, write a 3–4 sentence risk assessment paragraph. Your paragraph should:
...
**Writing goal:** Clearly identify the nature and source of a risk using neutral, precise language.
...
**Writing goal:** Explain the consequence of a risk and propose a realistic step to reduce it.
...
5. *To mitigate this, staff should being trained before the launch.*
...
Choose one of the following scenarios and write a risk and impact assessment.
...
**Practice:** Rewrite each sentence using an appropriate hedging or conditional structure. Avoid overstating certainty.
...
> → **[Context anchor]** The writer provides a date and a reference to an earlier document so that all readers — including those who did not receive the original — can identify what is being referred to.

> *"…should now be used for all applicant submissions."*
> → **[Universal instruction]** The core action is stated clearly before the audience-specific detail. All readers receive the main message, regardless of background.

> *"For colleagues already familiar with the revision…"*
> → **[Audience signal — internal]** The writer directly addresses one audience group, signalling that the following detail is specifically for them.

> *"For partner offices, we note that the revision was introduced to resolve inconsistencies…"*
> → **[Audience signal — external]** A second audience group is addressed separately, with different supporting information suited to their context.

> *"Should any questions arise…"*
> → **[Open invitation]** The writer closes with a low-pressure offer of support, appropriate for all audiences.

**Reflection:** Why does separating audience signals into distinct sentences or phrases improve clarity? What might happen if the writer tried to address all audiences in a single combined statement?
...
**Writing goal:** Address different readers explicitly and provide information appropriate to each audience.
...
**Writing goal:** Ensure that readers who did not attend earlier meetings or receive previous messages can still understand the message fully.
...
*All partner offices are expected to use the designated submission portal for all applicant file transfers. Email submission of files is no longer accepted as a primary channel. This change is intended to ensure secure handling of data, reduce processing delays caused by incomplete file transfers, and create a consistent audit trail across agencies. Offices that have not yet registered with the portal are required to do so by 30 April.*
...
**Writing goal:** Ground the rationale in existing rules, requirements, or organisational objectives.
...
**Writing goal:** Provide objective reasons grounded in process needs, and explain how the change improves outcomes.
...
Choose one scenario and write a policy-aligned rationale.
