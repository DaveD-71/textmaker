...
**Writing goal:** Replace section numbers, annexes, and legal citations with plain descriptions of what they require.
...
**Writing goal:** Help non-expert readers understand why the policy exists and what it will change for them.
...
**Writing goal:** Ensure non-expert readers know exactly what they need to do and when.
...
Write a briefing of approximately **220–260 words** for non-expert readers in partner offices. Your writing must:
...
**Writing goal:** Begin with a short, direct statement of what was decided. Avoid vague or hedged opening phrases.
...
**Writing goal:** Explain why the decision was made. Ground the rationale in policy, evidence, or procedural requirements — not personal preference.
...
**Writing goal:** Describe the practical or procedural advantages of the decision in specific, measurable terms where possible.
...
**Writing goal:** Combine decision, rationale, and benefit into a short, well-organised paragraph.
...
3. Your office has decided to update its internal records system to align with the new interagency data standards.
...
**Writing goal:** Begin with a single sentence that explains what the report covers, why it was produced, and how many sources it draws from.
...
**Writing goal:** Describe problems or challenges specifically and without attribution of blame.
...
**Writing goal:** Document completed actions in specific, factual terms.
...
**Writing goal:** State what will happen next, who is responsible, and by when.
...
Write a **270–310 word** consolidated administrative report on one of the following:
...
*"Circular 2024/11 introduces revised terminology, updated sequencing requirements, and new verification steps. Distribution: all examining offices. Acknowledg­ement of receipt required within seven days."*
...
#### 1. Error Identification and Correction (C4)
...
#### 2. Paragraph-Level Transformation (C5)
...
**Part A — Analysis (approximately 60 words):** Write a brief planning note (not for publication) identifying: the main issues, the audiences who need to be addressed, and the most appropriate document format.
...
- **[D]** = delete (unnecessary or repeated content)
...
#### Compare Two Versions — Exemplar Analysis (B1)
...
#### Error Identification and Correction — Self-Diagnosis (C4)
