...
#### Practice A — Identify the Function (C2)
...
#### Practice B — Sentence Rewriting (C3)
...
>
> *[Explanation — provide relevant background]*
>
> *[Request — state clearly what is needed]*
>
...
#### Task — Write a Full High-Level Email (190–220 words)
...
Write a **190–220 word** high-level email to an interagency counterpart requesting multiple actions related to a document review. The email must include:
...
#### Practice A — Sentence Rewriting (C3)
...
**Scenario:** You have received a revised procedural document. Two terms are used inconsistently, and one timeline appears to conflict with earlier correspondence.
...
#### Task — Role-Based Writing Task (E3) ★

You are an administrative coordinator at an interagency liaison office. A partner organisation has submitted a revised set of procedural guidelines, but your team has identified several inconsistencies. Your director has asked you to draft a clarification request on behalf of the office.
...
Write a **190–220 word** clarification request to a foreign office regarding inconsistencies found in a revised procedural document. Include:
...
#### Task — Write a Diplomatic Error Notification (190–220 words)
...
Write a **190–220 word** diplomatic error-notification email to a domestic or foreign office. Include:
...
#### Task — Write a Multi-Part Request Message (190–220 words)
...
1. Rewrite a multi-part request message you have previously sent — apply sequencing markers, dependency logic, and diplomatic softening.
2. Take a disorganised request email you have received and convert it into a clearly layered version; note what you changed and why.
3. Find a message in which the priority order of requests was not stated. Analyse what effect this had, and write an improved version.
