...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("input", nargs="?", help="Path to input .pptx file")
    parser.add_argument(
        "--input",
        dest="input_flag",
        help="Path to input .pptx file (alternative to positional input)",
    )
    parser.add_argument(
        "--output-dir",
        default=".",
...
def main() -> None:
    ...
    input_value = args.input_flag or args.input
    if not input_value:
        parser.error("input is required (positional or --input)")
