...
- **The single controlling document is `books/Let's Talk Finance/PROJECT-PLAN.md`** — scope, all 8 resolved decisions (D1–D8), the 8-phase production process, both full topic lists with 4-Part groupings, and the reference index. Read it first when resuming.
