...
- avoid unnecessary detail and emotional wording
...
1. Why is justification needed in government or interagency communication?
...
1. policy alignment
2. clear rationale
3. removal of unnecessary detail
4. concrete benefits
...
**Example:**
*The office will adopt the revised document-checking procedure.*
...
**Example:**
*This revision aligns with the updated terminology standards.*
...
**Example:**
*This will reduce review time and improve cross-office consistency.*
...
1. Decision to revise a guideline
2. Decision to update an internal system
3. Decision to implement a new workflow requirement
...
- is the justification too long or detailed?
- is the rationale vague or emotional?
...
1. Rewrite a justification you previously wrote at work.
