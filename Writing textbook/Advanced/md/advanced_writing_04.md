...
1. What elements must appear in an email between government agencies?
...
- Requesting confirmation of procedural steps
- Providing clarification on an inconsistency
...
1. **Opening / context**
2. **Purpose of email**
3. **Main information or explanation**
4. **Requests / required actions**
...
- a brief explanation of why the update is necessary
...
Use this template to write an email requesting:
...
1. Requesting updated translation files from a foreign office
2. Following up on a pending approval required for a report
3. Confirming whether an earlier instruction remains valid
...
- Are all requests clearly stated?
...
- has a clear purpose in the initial lines
- separates explanation from requests
- uses diplomatic phrasing
...
1. Rewrite an email from your work history that was difficult to structure.
