...
1. What types of information do you typically need to clarify in your work?
...
1. *Could you explain this part?*
2. *Could you confirm whether the date in Section 2.1 should be updated to match the revision dated 3 April?*
3. *What does this mean?*
4. *For our confirmation, could you clarify whether the "applicant response period" refers to calendar days or business days?*
...
3. **Clear scope** of what is being asked
4. **Next step** after receiving clarification
...
- context
- at least 2 numbered clarification points
...
Write a message requesting clarification on:

- two term definitions
...
1. An international office used inconsistent terminology in a procedural document.
2. A domestic agency provided a revision with unclear timelines.
3. A partner office submitted a translation with ambiguous phrasing.

Your message must include:

- explicit context
- structured questions (at least 3)
- diplomatic tone
...
- which questions are precise
- any ambiguity remaining
...
1. Rewrite a clarification request you sent in the past to make it more precise.
...
- a clear next step once clarification is received
