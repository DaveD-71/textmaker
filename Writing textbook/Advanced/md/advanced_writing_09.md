...
- identify risks, impacts, and necessary follow-up actions
...
1. A domestic agency revised its applicant response process.
2. A foreign office updated terminology used in procedural documents.
3. Your team changed the internal workflow for confirming translations.

Write a structured notice including:
...
2. Notification of a policy adjustment affecting applicants
3. Revision of an interagency coordination workflow
...
- assumes prior knowledge not shared by the reader
- fails to specify what exactly has changed
- lacks rationale or next steps
...
1. *"We updated the system. Please follow the new rules."*
2. *"Some steps have changed, so check the form."*
