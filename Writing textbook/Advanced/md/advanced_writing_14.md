...
1. Who reads your documents (colleagues, managers, agencies, foreign offices)?
...
Read:
>
>*"As explained last week, the revised instructions should be used. Everyone knows why the changes were made, so please follow the updated process."*
...
1. information for internal users
2. information for external or international users
3. bridging information that supports both audiences
4. references that help unfamiliar readers understand the message
...
**Example:**
*For partner offices unfamiliar with the revision, the update aims to clarify the review timeline.*
...
**Example:**
*The main change concerns the terminology in Section 3. For those unfamiliar with the previous version, the new terminology aligns with updated agency standards.*
...
**Example:**
*The revision addresses questions raised during the September consultation sessions.*
...
**Example:**
*This message provides: (1) background on the revision, (2) a summary of changes, and (3) next steps for implementation.*
...
1. New procedural instructions affecting domestic and international offices
...
- a **short form** for internal staff familiar with the topic
- a **long form** for external offices
...
1. Announcement of a major procedural update
2. Coordination message for a multi-office project
3. Explanation of changes to an interagency workflow
...
- assumes the reader attended a meeting or read earlier messages
- lacks context or explanation for external audiences
...
1. Rewrite a message you sent that assumed too much prior knowledge.
