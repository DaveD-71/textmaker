...
- organise information into a unified structure
...
1. How is synthesising information different from summarising one text?
...
1. *Office A reports delays due to unclear terminology.*
2. *Office B reports that terminology is clear, but the timeline is unrealistic.*
3. *Office C reports both timeline issues and confusion about terminology.*
...
1. grouped themes
2. synthesis language (e.g., *across*, *while*, *indicate*)
...
**Example:**
*Two themes appear across the responses: inconsistent terminology and missing data.*
...
**Example:**
*While some offices agree the terminology is clear, others report ongoing confusion.*
...
**Example:**
*Together, these points suggest that additional clarification is required before implementation.*
...
- *The translation process is slow due to resource shortages.*
...
- meeting notes
- an email update
- a revised procedural instruction
...
1. Synthesis of interagency feedback
2. Synthesis of applicant communication issues
3. Synthesis of guideline revision comments
...
- Are you merely listing information?
- Are themes grouped properly?
- Is there a concluding insight?
...
1. Turn a long set of notes into a one-paragraph synthesis.
