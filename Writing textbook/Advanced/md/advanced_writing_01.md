...
- the **primary action** of the sentence
- all **supporting reasons**
- places where the reader must hold too much information at once
- where you would naturally pause if reading aloud
...
- the main clause competes with multiple long subordinate clauses
...
1. a fully subordinated version
2. a coordinated version
...
- delays in confirming translation accuracy
...
- connectors match the logic you intend to show
...
1. Take a paragraph from an actual work email and rewrite it using **all three clarity patterns** (subordination, coordination, segmentation).
...
- at least 1 segmented idea (split into multiple sentences)

Make sure the writing would be appropriate for internal or interagency communication.
