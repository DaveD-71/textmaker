...
1. *You made a mistake in the attached file.*
2. *There appears to be an inconsistency in the attached file.*
3. *This is wrong. Please fix it.*
4. *For our confirmation, could you review the highlighted section below?*
...
1. A domestic agency submitted incorrect data.
2. A foreign office sent an outdated version of a document.
3. A colleague misinterpreted a procedural change.
4. An applicant's representative submitted conflicting explanations.
...
1. **Neutral presentation of the issue**
2. **Non-blaming language**
3. **Softening expressions**
4. **Reference to a specific section or instruction**
5. **Clear next steps**
...
2. *the attached version is outdated.*
...
1. A colleague submitted an outdated version of the meeting summary.
2. A foreign office used inconsistent terminology.
3. A domestic agency misunderstood a procedural instruction.

Include:

- neutral identification of the issue
...
3. **Impact / reason for correction**
4. **Request**
5. **Next step**
...
- diplomatic framing
- specific reference to sections or information
- neutral explanation of the issue
- impact statement
- correction request
...
- direct or accusatory tone
- unclear or missing references
- lack of context for the issue
...
- at least 2 specific references (sections, terms, dates)
