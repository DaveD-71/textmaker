...
1. What information must appear in an executive-level summary?
...
>
> - Several offices noted that the updated terminology may conflict with existing documents.
> - The current implementation timeline was identified as unrealistic due to required system updates.
> - Additional clarification is needed regarding the applicant communication process.
>
> **Decisions / Action Items:**
>
> - Office A will provide a consolidated list of terminology inconsistencies by 18 October.
> - Office B will draft a revised implementation timeline for circulation.
...
**Example:**
*The meeting focused on three key issues: terminology, timelines, and communication steps.*

Useful organisational labels:
...
1. *The group agreed to review the revised draft by Friday.*
2. *Two offices raised questions about the new process.*
...
**Example:**
*Several offices expressed concern regarding the lack of clarity in Section 3.*
...
**Example:**
*Office C will prepare a revised draft by 22 November.*
...
- Office D will provide updated template
...
- one for an **internal department head**
- one for a **foreign office**
...
1. Interagency coordination meeting
2. Policy update briefing
3. International working group session
...
- includes unnecessary narrative detail
- lacks structure or labels
- omits important decisions or follow-up actions
...
1. Rewrite a summary from a real meeting you attended.
