...
- Which sentences feel unrelated?
...
- connectors
- thematic connection between sentences
...
2. **Support:** Explain details, evidence, or background.
3. **Implication:** Show the next step, consequence, or conclusion.

Write a paragraph based on one of the following:

- clarifying a process change
...
1. Summarise the outcome of an interagency coordination meeting.
2. Explain a problem affecting timely applicant processing.
3. Describe why a procedural update is required.

Your paragraph must include:

- at least 4 cohesive devices
- at least 3 reference words
...
1. Take a paragraph from a real email or report and revise it for cohesion.
