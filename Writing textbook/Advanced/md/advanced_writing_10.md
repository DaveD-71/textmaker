...
2. how each factor is explained
3. the relationship between factors
4. the concluding next-step statement
...
**Example:**
*The delay occurred due to three primary factors: X, Y, and Z.*
...
1. *Several discrepancies were identified in the data.*
...
**Example:**
*For example, the term "response period" appears to be used with two different meanings in the revised guidelines.*
...
**Example:**
*These points need clarification before further analysis can proceed.*
...
Choose one:
1. Multi-office coordination delays
2. Translation inconsistencies affecting timelines
3. Conflicting instructions in new guidelines

Your explanation must include:
- at least three factors
- supporting details
- clear relationships between factors
...
## Extension Task
Choose one:
1. Rewrite a complex explanation from your workplace.
