...
- write clear, structured explanations of policies, revisions, and requirements
...
1. Which audiences in your work are *not* specialists in your policy area?
...
4. how technical detail is simplified
...
**Example:**
*The requirement in Section 12(4) means offices must now check the completeness of applications.*
...
**Example:**
*The new step helps ensure that important information is not overlooked.*
...
**Example:**
*Offices should begin using the updated form starting next month.*
...
1. A new step added to the applicant communication process
...
1. Summary of a major procedural revision
2. Explanation of a new interagency policy
3. Summary of changes affecting applicant processing
...
- Is any language too technical?
- Does the summary assume prior knowledge?
...
1. Rewrite a technical policy excerpt from your workplace.
